export const site = {
  ...
  description:
    'Fernando Huamancaja is a cloud and AI integration engineer at CapTech. He builds Azure infrastructure with Terraform, orchestrates AI agents with Semantic Kernel on Azure AI Foundry, and ships .NET APIs and event-driven integrations.',
  tagline: 'Azure · Terraform · .NET · Semantic Kernel · AI Foundry',
  links: {
  ...
  about: [
    ...
    'My current focus is agentic AI in .NET. I orchestrate multi-agent workflows with Semantic Kernel, expose them as API endpoints, and build scoring and evaluation agents so quality is measured, not assumed.',
  ...
  heroChips: ['Azure', 'Terraform', 'Semantic Kernel', 'AI Foundry', '.NET'],
} as const;
